...
var ProductModal = (function (_super) {
    ...
    function ProductModal(productId) {
        ...
        _this.photoNumber = 1;
        _this.render(productId).then(function () {
